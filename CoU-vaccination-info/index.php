...
require "includes/connect_db.php";
	...
	$conn=getDB(); //get database connection
 	...
 	if(isset($_POST['entity'])) //if found entity  and value for filter search then redirect to view.php 
	{
	...
	<button class="hide" onclick="document.getElementById('v_std').style.display='none';">Hide>></button>
		<div class="show">
			<?php
					...
					$arr=get_element($conn,$sql);
					include 'includes/show_table.php'; //include show_table.php to print info 
			?>
	</div>
</div>
